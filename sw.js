const CACHE="kriptodanik-v1.8.3";
const CORE=["./","./index.html","./style.css?v=1.8.3","./brand-fallback.js?v=1.8.3","./app.js?v=1.8.3","./chart.js?v=1.8.3","./manifest.webmanifest","./assets/logo-brand.png","./assets/avatar-circle-clean.png","./assets/hero-character-clean.png"];
